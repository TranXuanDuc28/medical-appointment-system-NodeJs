...
var getAllPackages = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _index["default"].Package.findAll({
            where: {
              isActive: true
            },
            include: [{
              model: _index["default"].Facility,
              as: 'facilityData',
  ...
  return function getAllPackages(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var getFeaturedPackages = /*#__PURE__*/function () {
  ...
  return function getFeaturedPackages(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var getPackageById = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    var id, packageData, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 2:
          _context3.n = 3;
          return _index["default"].Package.findOne({
            where: {
              id: id,
              isActive: true
            },
  ...
  return function getPackageById(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var searchPackages = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    var _req$query, keyword, category, gender, minPrice, maxPrice, facilityId, specialtyId, ageRange, _req$query$sortBy, sortBy, _req$query$sortOrder, sortOrder, _req$query$limit, limit, _req$query$offset, offset, whereClause, allowedSortFields, allowedSortOrders, orderClause, packages, categories, ageRanges, _t4;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _req$query = req.query, keyword = _req$query.keyword, category = _req$query.category, gender = _req$query.gender, minPrice = _req$query.minPrice, maxPrice = _req$query.maxPrice, facilityId = _req$query.facilityId, specialtyId = _req$query.specialtyId, ageRange = _req$query.ageRange, _req$query$sortBy = _req$query.sortBy, sortBy = _req$query$sortBy === void 0 ? 'createdAt' : _req$query$sortBy, _req$query$sortOrder = _req$query.sortOrder, sortOrder = _req$query$sortOrder === void 0 ? 'DESC' : _req$query$sortOrder, _req$query$limit = _req$query.limit, limit = _req$query$limit === void 0 ? 10 : _req$query$limit, _req$query$offset = _req$query.offset, offset = _req$query$offset === void 0 ? 0 : _req$query$offset;
          whereClause = {
            isActive: true
          ...
          if (minPrice || maxPrice) {
            whereClause.price = {};
            if (minPrice) whereClause.price[_sequelize.Op.gte] = parseFloat(minPrice);
            if (maxPrice) whereClause.price[_sequelize.Op.lte] = parseFloat(maxPrice);
          }
          ...
          allowedSortFields = ['name', 'price', 'createdAt', 'isFeatured'];
          ...
          _context4.n = 1;
          return _index["default"].Package.findAndCountAll({
            where: whereClause,
            include: [{
              model: _index["default"].Facility,
              as: 'facilityData',
        ...
        case 1:
          packages = _context4.v;
          _context4.n = 2;
          return _index["default"].Package.findAll({
            where: {
              isActive: true
            },
            attributes: [[_index["default"].sequelize.fn('DISTINCT', _index["default"].sequelize.col('category')), 'category']],
            raw: true
          });
        case 2:
          categories = _context4.v;
          _context4.n = 3;
          return _index["default"].Package.findAll({
            where: {
              isActive: true
            },
            attributes: [[_index["default"].sequelize.fn('DISTINCT', _index["default"].sequelize.col('ageRange')), 'ageRange']],
            raw: true
          });
        case 3:
          ageRanges = _context4.v;
          return _context4.a(2, res.status(200).json({
            ...
            data: {
              ...
              filters: {
                ...
                ageRanges: ageRanges.map(function (a) {
                  return a.ageRange;
                }).filter(Boolean)
              }
            }
  ...
  return function searchPackages(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var createPackage = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(req, res) {
    var data, newPackage, _t5;
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 1:
          _context5.n = 2;
          return _index["default"].Package.create({
            name: data.name,
  ...
  return function createPackage(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var updatePackage = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(req, res) {
    var id, data, packageData, _t6;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        ...
        case 1:
          _context6.n = 2;
          return _index["default"].Package.findByPk(id);
        case 2:
          packageData = _context6.v;
          if (packageData) {
            _context6.n = 3;
            break;
          }
  ...
  return function updatePackage(_x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
var deletePackage = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(req, res) {
    var id, packageData, _t7;
  ...
  return function deletePackage(_x11, _x12) {
    return _ref7.apply(this, arguments);
  };
}();
var getFilterOptions = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(req, res) {
    var categories, ageRanges, genders, facilities, specialties, priceStats, _t8;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        ...
        case 2:
          ageRanges = _context8.v;
          _context8.n = 3;
          return _index["default"].Package.findAll({
            where: {
              isActive: true
            },
            attributes: [[_index["default"].sequelize.fn('DISTINCT', _index["default"].sequelize.col('gender')), 'gender']],
            raw: true
          });
        case 3:
          genders = _context8.v;
        ...
        case 5:
          ...
          return _index["default"].Package.findOne({
            ...
            attributes: [[_index["default"].sequelize.fn('MIN', _index["default"].sequelize.col('price')), 'minPrice'], [_index["default"].sequelize.fn('MAX', _index["default"].sequelize.col('price')), 'maxPrice']],
            raw: true
          });
        case 6:
          priceStats = _context8.v;
          return _context8.a(2, res.status(200).json({
            ...
            data: {
              ...
              genders: genders.map(function (g) {
                return g.gender;
              }).filter(Boolean),
...
module.exports = {
  ...
  getFeaturedPackages: getFeaturedPackages,
