    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return chatServices.getMsg(req.params.receiverId, req.query.userId, parseInt(req.query.offset) || 0);
        case 1:
          infor = _context.v;
...
var delMsg = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return chatServices.delMsg(req.params.id);
        case 1:
          infor = _context2.v;
  ...
  return function delMsg(_x3, _x4) {
