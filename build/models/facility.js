...
module.exports = function (sequelize, DataTypes) {
  var Facility = /*#__PURE__*/function (_Model) {
    function Facility() {
      _classCallCheck(this, Facility);
      return _callSuper(this, Facility, arguments);
    }
    _inherits(Facility, _Model);
    return _createClass(Facility, null, [{
      key: "associate",
      value:
      /**
      ...
      function associate(models) {
        ...
        Facility.hasMany(models.Package, {
  ...
  Facility.init({
    ...
    // JSON string of working hours
    services: DataTypes.TEXT,
    // JSON string of available services
    specialties: DataTypes.TEXT,
    // JSON string of specialties
    images: DataTypes.TEXT,
    // JSON string of facility images
