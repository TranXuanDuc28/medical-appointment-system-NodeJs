    ...
    for (var _t15 in e)
      "default" !== _t15 &&
        ...
        ((i =
          ...
          Object.getOwnPropertyDescriptor(e, _t15)) &&
        (i.get || i.set)
          ? o(f, _t15, i)
          : (f[_t15] = e[_t15]));
    return f;
...
var getTopDoctorHomeServices = function getTopDoctorHomeServices(
  limitInput,
  lang
) {
                          ...
                          include: [
                            {
                              ...
                              include: [
                                {
                                  model:
                                    _models["default"].Specialty_Translation,
                                  where: {
                                    lang: lang,
                                  },
                                  as: "specialtyData",
                ...
                switch ((_context4.p = _context4.n)) {
                  ...
                  case 10:
                    ...
                    return _models["default"].Doctor_Infor.create({
                      ...
                      clinicId:
                        inputData.clinicId !== "" ? inputData.clinicId : null,
                      lang: inputData.lang,
                    });
                  case 11:
                    _context4.n = 13;
                  ...
                  case 12:
                    _context4.p = 12;
                    _t4 = _context4.v;
                    _inspector.console.error(
                      "Error creating doctor info:",
                      _t4
                    );
                  case 13:
                    resolve({
...
var getDetailDoctorByIdServices = function getDetailDoctorByIdServices(
  inputId,
  lang
) {
...
var getScheduleDoctorByDateServices = function getScheduleDoctorByDateServices(
  _ref7
) {
...
var getExtraDoctorInforByIdServices = function getExtraDoctorInforByIdServices(
  inputId,
  lang
) {
  return new Promise(
...
var getProfileDoctorByIdServices = function getProfileDoctorByIdServices(
  inputId,
  lang
) {
  return new Promise(
    /*#__PURE__*/ (function () {
      var _ref0 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee9(resolve, reject) {
          var doctors, _t0;
          return _regenerator().w(
            function (_context9) {
              while (1)
...
var getListPatientForDoctor = function getListPatientForDoctor(
  doctorId,
  roleId,
  date,
  lang
  ...
  return new Promise(
    /*#__PURE__*/ (function () {
      var _ref1 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee0(resolve, reject) {
          var data, _t1;
          return _regenerator().w(
            function (_context0) {
              while (1)
                switch ((_context0.p = _context0.n)) {
                  ...
                  case 1:
                    ...
                    return _models["default"].Booking.findAll({
                      where: {
                        statusId: _defineProperty({}, _sequelize.Op["in"], [
                          "S5",
                          "S6",
                        ]),
                      },
  ...
  return new Promise(
    /*#__PURE__*/ (function () {
      var _ref10 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee1(resolve, reject) {
          var appointment,
            appointmentData,
            timeString,
            pdfBase64,
              ...
              while (1)
                switch ((_context1.p = _context1.n)) {
                  case 0:
                    _context1.p = 0;
                    if (
                      !(!data.doctorId || !data.patientId || !data.timeType)
                    ) {
                      _context1.n = 1;
                      break;
                    }
                  ...
                  case 3:
                    ...
                    return getPrescriptionPDFBase64({
                      ...
                      doctorName: ""
                        .concat(
                          appointmentData.doctorInforData.doctorData.firstName,
                          " "
                        )
                        .concat(
                          appointmentData.doctorInforData.doctorData.lastName
                        ),
                    });
                  case 4:
                    pdfBase64 = _context1.v;
                    // process.stdout.write("pdfBase64: " + pdfBase64 + "\n");
                    data.imgBase64 = "data:application/pdf;base64,".concat(
                      pdfBase64
                    );
  ...
  return new Promise(
    /*#__PURE__*/ (function () {
      var _ref11 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee10(resolve, reject) {
  ...
  return new Promise(
    /*#__PURE__*/ (function () {
      var _ref12 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee11(resolve, reject) {
              ...
              while (1)
                switch ((_context11.p = _context11.n)) {
                  ...
                  case 5:
                    ...
                    _context11.n = 6;
                    return _emailServices["default"].sendEmailPaymentSuccess(
                      dataSend
                    );
                  case 6:
                    resolve({
  ...
  return new Promise(
    /*#__PURE__*/ (function () {
      var _ref13 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee12(resolve, reject) {
  ...
  return new Promise(
    /*#__PURE__*/ (function () {
      var _ref14 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee13(resolve, reject) {
          var description,
            match,
            bookingId,
            booking,
                ...
                switch ((_context13.p = _context13.n)) {
                  ...
                  case 5:
                    ...
                    cashiers.forEach(function (cashier) {
                      io.to(cashier.socketId).emit(
                        "PAYMENT_CONFIRMED",
                        _objectSpread(
                          _objectSpread({}, notificationData),
                          {},
                          {
                            role: "cashier",
                          }
