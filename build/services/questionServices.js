...
var testsConfig = {
  BDI_II: {
    totalQuestions: 21,
    scoring: "sum",
    ranges: [[0, 9, "Không trầm cảm hoặc rất nhẹ"], [10, 18, "Trầm cảm nhẹ – trung bình"], [19, 29, "Trầm cảm vừa"], [30, 63, "Trầm cảm nặng"]]
  },
  PHQ_9: {
    totalQuestions: 10,
    scoring: "sum",
    ranges: [[0, 4, "Răng miệng khỏe"], [5, 9, "Nguy cơ nhẹ"], [10, 14, "Trung bình, nên khám nha sĩ"], [15, 20, "Nghiêm trọng, cần điều trị"]]
  }
...
function calculateScore(answers, questions, testKey) {
  ...
  if (!config) {
    throw new Error("Ch\u01B0a c\xF3 c\u1EA5u h\xECnh cho test ".concat(testKey));
  }
  var totalScore = 0;
  var maxScore = 0;
  ...
  try {
    var _loop = function _loop() {
      ...
      // Tính điểm tối đa
      var maxQuestionScore = Math.max.apply(Math, _toConsumableArray(question.options.map(function (o) {
        return o.score;
      })));
  ...
  if (answers.length < config.totalQuestions) {
    totalScore = Math.round(totalScore * config.totalQuestions / answers.length);
...
function _getHealthAdvice() {
  _getHealthAdvice = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(answers, scoreResult, questions) {
    ...
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.p = _context9.n) {
        case 0:
          ...
          answerDetails = answers.map(function (answer, index) {
        ...
        case 3:
          ...
          return _context9.a(2, "Không thể lấy lời khuyên từ AI vào lúc này.");
      }
    }, _callee9, null, [[0, 3]]);
  }));
  return _getHealthAdvice.apply(this, arguments);
...
var submitAssessment = function submitAssessment(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(resolve, reject) {
      var userId, category_question_id, testKey, answers, questions, questionsForScore, scoreResult, aiAdvice, assessment, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            userId = data.userId, category_question_id = data.category_question_id, testKey = data.testKey, answers = data.answers;
          ...
          case 2:
            ...
            scoreResult = calculateScore(answers, questionsForScore, testKey);
            console.log("Score Result:", scoreResult);
            process.stdout.write("Score Result: " + JSON.stringify(scoreResult) + "\n");

            // Gọi AI để lấy lời khuyên
            _context.n = 3;
            return getHealthAdvice(answers, scoreResult, questionsForScore);
          case 3:
            aiAdvice = _context.v;
...
var getQuestionsByCategory = function getQuestionsByCategory(category_question_id) {
  return new Promise(/*#__PURE__*/function () {
...
var createNewCategoryQuestion = function createNewCategoryQuestion(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(resolve, reject) {
      var _yield$db$Category_Qu, _yield$db$Category_Qu2, category, created, _t4;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.p = _context4.n) {
          ...
          case 2:
            ...
            _yield$db$Category_Qu2 = _slicedToArray(_yield$db$Category_Qu, 2);
